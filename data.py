...
Clinic(manager=ClinicManager.objects.get(pk=1), name="North Lamma General Out-patient Clinic", latitude=22.224295, longitude=114.111098, altitude=20).save()
Clinic(manager=ClinicManager.objects.get(pk=2), name="Peng Chau General Out-patient Clinic", latitude=22.283621, longitude=114.039154, altitude=8).save()
Clinic(manager=ClinicManager.objects.get(pk=3), name="Sok Kwu Wan General Out-patient Clinic", latitude=22.205606, longitude=114.131597, altitude=21).save()
Clinic(manager=ClinicManager.objects.get(pk=4), name="Tai O Jockey Club General Out-patient Clinic", latitude=22.255725, longitude=113.857972, altitude=2).save()
Clinic(manager=ClinicManager.objects.get(pk=5), name="Aberdeen Jockey Club General Out-patient Clinic", latitude=22.249740, longitude=114.156384, altitude=44).save()
Clinic(manager=ClinicManager.objects.get(pk=6), name="Ap Lei Chau General Out-patient Clinic", latitude=22.243243, longitude=114.153765, altitude=56).save()
Clinic(manager=ClinicManager.objects.get(pk=7), name="Mui Wo General Out-patient Clinic", latitude=22.266040, longitude=113.997882, altitude=17).save()

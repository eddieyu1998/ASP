...
DistanceBetweenLocation(location1=Location.objects.get(name="Mui Wo General Out-patient Clinic"), location2=Location.objects.get(name="Aberdeen Jockey Club General Out-patient Clinic"), distance=16.24).save()
...
DistanceBetweenLocation(location1=Location.objects.get(name="North Lamma General Out-patient Clinic"), location2=Location.objects.get(name="Aberdeen Jockey Club General Out-patient Clinic"), distance=4.87).save()
...
DistanceBetweenLocation(location1=Location.objects.get(name="Peng Chau General Out-patient Clinic"), location2=Location.objects.get(name="Aberdeen Jockey Club General Out-patient Clinic"), distance=12.62).save()
...
DistanceBetweenLocation(location1=Location.objects.get(name="Sok Kwu Wan General Out-patient Clinic"), location2=Location.objects.get(name="Aberdeen Jockey Club General Out-patient Clinic"), distance=4.77).save()
...
DistanceBetweenLocation(location1=Location.objects.get(name="Tai O Jockey Club General Out-patient Clinic"), location2=Location.objects.get(name="Aberdeen Jockey Club General Out-patient Clinic"), distance=30.47).save()
...
DistanceBetweenLocation(location1=Location.objects.get(name="Aberdeen Jockey Club General Out-patient Clinic"), location2=Location.objects.get(name="Aberdeen Jockey Club General Out-patient Clinic"), distance=0.77).save()
...
DistanceBetweenLocation(location1=Location.objects.get(name="Aberdeen Jockey Club General Out-patient Clinic"), location2=Location.objects.get(name="Queen Mary Hospital Drone Port"), distance=3.79).save()
